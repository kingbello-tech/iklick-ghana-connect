...
const team: Member[] = [
  ...
  {
    id: 6, name: "Aseda Sasu-Boamah", role: "Business Support", image: null,
    email: "aseda@iklickgh.com", linkedin: "#",
    bio: "Aseda champions the voice of every iKlick client. She leads support, satisfaction, and SLA programs — making sure clients feel heard and that every issue is resolved quickly and completely.",
  },
];
