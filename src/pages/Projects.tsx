...
import projectCommunityWifi from "@/assets/project-community-wifi.jpg";
import projectCommunityMesh from "@/assets/project-community-mesh.jpg";
import projectFtth from "@/assets/project-ftth.jpg";
import projectFiberNetwork from "@/assets/project-fiber-network.jpg";
import projectUniversityWifi from "@/assets/project-university-wifi.jpg";
import projectHostelWifi from "@/assets/project-hostel-wifi.jpg";
import featuredCommunity from "@/assets/project-featured-community.jpg";
import featuredFtth from "@/assets/project-featured-ftth.jpg";
import featuredUniversity from "@/assets/project-featured-university.jpg";
...
const projects: Project[] = [
  {
    ...
    stats: [{ label: "Hotspots Deployed", value: "50+" }, { label: "Daily Users", value: "10,000+" }, { label: "Coverage Area", value: "25 km²" }],
  ...
  {
    id: 3, title: "East Legon FTTH Rollout", category: "ftth", location: "East Legon, Accra",
  ...
  {
    id: 4, title: "Spintex Road Fiber Network", category: "ftth", location: "Spintex, Accra",
  ...
  {
    id: 5, title: "University of Ghana Hostel WiFi", category: "university", location: "Legon, Accra",
    ...
    stats: [{ label: "Students Served", value: "15,000+" }, { label: "Access Points", value: "200+" }, { label: "Concurrent Users", value: "5,000+" }],
    image: projectUniversityWifi,
  },
  {
    id: 6, title: "KNUST Hostel Connectivity", category: "university", location: "Kumasi",
    ...
    stats: [{ label: "Hostels Covered", value: "12" }, { label: "Students Connected", value: "8,000+" }, { label: "Bandwidth", value: "10 Gbps" }],
    image: projectHostelWifi,
  },
];
...
const featuredSections = [
  {
    category: "community", title: "Community WiFi", subtitle: "Connecting Communities, Empowering People",
    ...
    stats: [{ value: "85+", label: "Hotspots Deployed" }, { value: "15,000+", label: "Daily Users" }, { value: "50 km²", label: "Total Coverage" }],
    image: featuredCommunity,
  },
  {
    category: "ftth", title: "Fiber to the Home", subtitle: "Ultra-Fast Fiber, Right to Your Doorstep",
    ...
    stats: [{ value: "1,300+", label: "Homes Connected" }, { value: "60+ km", label: "Fiber Laid" }, { value: "99.9%", label: "Network Uptime" }],
    image: featuredFtth,
  },
  {
    category: "university", title: "University Hostel WiFi", subtitle: "Powering Campus Life with Seamless WiFi",
    ...
    stats: [{ value: "23,000+", label: "Students Served" }, { value: "400+", label: "Access Points" }, { value: "20 Gbps", label: "Total Bandwidth" }],
    image: featuredUniversity,
  },
];
            ...
            {filters.map((f) => (
              <button key={f.key} onClick={() => setActiveFilter(f.key)}
                className={`px-5 py-2.5 rounded-full text-sm font-medium transition-all duration-300 ${
                  activeFilter === f.key ? "bg-primary text-primary-foreground shadow-lg shadow-primary/25" : "bg-muted text-muted-foreground hover:bg-muted/80 hover:text-foreground"
                }`}>{f.label}</button>
            ))}
          </div>
        </div>
    ...
    <div ref={ref}
      ...
      <div className="p-6">
        ...
        <div className="overflow-hidden max-h-0 group-hover:max-h-12 transition-all duration-300">
          <a href="mailto:sales@iklickgh.com">
            <Button variant="hero" size="sm" className="w-full">Learn More <ChevronRight className="w-4 h-4 ml-1" /></Button>
          </a>
        </div>
      </div>
    </div>
      ...
      <div className="container mx-auto px-4">
        <div className={`flex flex-col ${reversed ? "lg:flex-row-reverse" : "lg:flex-row"} gap-12 items-center`}>
          <div className={`flex-1 transition-all duration-700 ${isVisible ? "opacity-100 translate-x-0" : `opacity-0 ${reversed ? "translate-x-8" : "-translate-x-8"}`}`}>
            <div className="aspect-[4/3] rounded-2xl border border-border overflow-hidden">
              <img src={section.image} alt={section.title} loading="lazy" width={1200} height={900} className="w-full h-full object-cover" />
            </div>
          </div>
          <div className={`flex-1 transition-all duration-700 delay-200 ${isVisible ? "opacity-100 translate-x-0" : `opacity-0 ${reversed ? "-translate-x-8" : "translate-x-8"}`}`}>
            ...
            <div className="grid grid-cols-3 gap-6">
              {section.stats.map((stat) => (<AnimatedStat key={stat.label} value={stat.value} label={stat.label} />))}
            </div>
          </div>
        </div>
      </div>
